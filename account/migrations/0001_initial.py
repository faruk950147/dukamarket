# Generated by Django 4.2.16 on 2026-04-01 10:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, null=True, unique=True, validators=[django.core.validators.RegexValidator('^\\+?\\d{10,15}$', 'Enter a valid phone number')])),
            ...
            options={
                ...
                'db_table': 'user',
                'ordering': ['id'],
                'indexes': [models.Index(fields=['country', 'city'], name='user_country_fb519d_idx')],
            },
        ),
    ]
