# Generated by Django 4.2.16 on 2026-04-06 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otp_type', models.CharField(choices=[('register', 'Register'), ('reset', 'Password Reset')], max_length=20)),
            ...
            options={
                ...
                'db_table': 'otp',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'otp_type', 'created_at'], name='otp_user_id_e0b92c_idx'), models.Index(fields=['user', 'otp_type', 'is_used'], name='otp_user_id_40fb2a_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='user',
